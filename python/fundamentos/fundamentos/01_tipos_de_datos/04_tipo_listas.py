...
# 🗂️ Acceder a los valores - Índices en las listas
...
# ✂️ Slicing: Nos permite regresar una copia de parte de nuestra lista en base a índices específicos
...
# 🛠️ Funciones integradas : len(secuencia) - Regresa la cantidad de elementos en la secuencia. 
vocales = ['a', 'e', 'i', 'o', 'u']
